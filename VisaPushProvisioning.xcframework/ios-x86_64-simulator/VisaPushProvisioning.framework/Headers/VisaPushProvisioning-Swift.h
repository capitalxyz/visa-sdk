...
/// Optional parameter for internal use
...
typedef SWIFT_ENUM(NSInteger, VPTestScenario, open) {
  ...
  VPTestScenarioGetWalletsSuccess = 7,
  VPTestScenarioClickToPayAlreadyProvisioned = 8,
  VPTestScenarioClickToPayProvisioningSuccess = 9,
  VPTestScenarioClickToPayProvisioningFailed = 10,
  VPTestScenarioClickToPayProvisioningInconclusiveError = 11,
  VPTestScenarioClickToPayProvisioningFailedSessionTimeout = 12,
};
